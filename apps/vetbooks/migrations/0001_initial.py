    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vetbooks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vaccinations', to='vetbooks.vetbooks')),
            ],
        ),
        migrations.CreateModel(
            name='Treatment',
            fields=[
                ...
                ('vetbooks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='treatments', to='vetbooks.vetbooks')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vetbooks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='extended_treatments', to='vetbooks.vetbooks')),
            ],
        ),
        migrations.CreateModel(
            name='ClinicVisit',
            fields=[
                ...
                ('vetbooks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinic_visits', to='vetbooks.vetbooks')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinic', models.CharField(blank=True, max_length=255, null=True)),
                ('vetbooks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='examinations', to='vetbooks.vetbooks')),
            ],
        ),
    ]
