    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vetbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vaccinations', to='vetbooks.vetbook')),
            ],
        ),
        migrations.CreateModel(
            name='Treatment',
            fields=[
                ...
                ('vetbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='treatments', to='vetbooks.vetbook')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vetbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='extended_treatments', to='vetbooks.vetbook')),
            ],
        ),
        migrations.CreateModel(
            name='ClinicVisit',
            fields=[
                ...
                ('vetbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinic_visits', to='vetbooks.vetbook')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinic', models.CharField(blank=True, max_length=255, null=True)),
                ('vetbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='examinations', to='vetbooks.vetbook')),
            ],
        ),
    ]
